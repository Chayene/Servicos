...
public class ChamadoController {
    ...
    @GetMapping("/chamadosPeloStatus")
        ...
        List<Chamado> chamados= chamadoService.buscarChamadosPelosStatus(status);
        return chamados;
    }
    ...
    //aqui vamos definir o endpoint para o serviço de cadastro de novo chamado
...
// vamos mapear o serviço de excluir um chamado
    ...
    // vamos mapearoserviço de editar um chamado
    ...
    // vms fazer o mapeamento do método de atribuir um funcionario a um determinado chamado
    ...
    // vamos construir o mapeamento do metodo para modifcar o status de um chamado
