...
public class EnderecoClienteController {
    ...
    public List<EnderecoCliente> mostrarTodosEnderecosClientes() {
        List<EnderecoCliente> enderecos= enderecoClienteService.mostrarTodosEnderecosClientes();
        return enderecos;
    }
    @GetMapping("enderecoCliente/{idEnderecoCliente}")
    public ResponseEntity<EnderecoCliente> mostrarUmEnderecoPeloID(@PathVariable Integer idEnderecoCliente){
        EnderecoCliente enderecoCliente=enderecoClienteService.mostrarUmEnderecoPeloID(idEnderecoCliente);
