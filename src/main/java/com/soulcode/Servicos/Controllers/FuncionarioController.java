...
@CrossOrigin //evita erro entre diferentes portas, app de portas diferentes podem acessar aqui
@RestController
...
public class FuncionarioController {
    ...
    public List<Funcionario> mostrarTodosFuncionarios() {
        List<Funcionario> funcionarios = funcionarioService.mostrarTodosFuncionario();
        return funcionarios;
    }
    ...
    public ResponseEntity<Funcionario> cadastrarFuncionario(@PathVariable Integer idCargo, @RequestBody Funcionario funcionario) {
        // o funcionario já e salvo na tabela do database
        //agora precisamos criar um uri para esse novo registroda tabela
