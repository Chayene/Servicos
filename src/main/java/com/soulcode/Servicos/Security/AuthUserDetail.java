...
// abstrai o User do banco p que o security conheca esses dados
public class AuthUserDetail  implements UserDetails {
    ...
    public boolean isAccountNonExpired() {
        return true;
    } // a conta não expirou-true

    @Override
    public boolean isAccountNonLocked() {
        return true;
    } // a conta não bloqueou- true

    @Override
    public boolean isCredentialsNonExpired() {
        return true;
    } // as crendenciais não expiraram-true

    @Override
    public boolean isEnabled() {
        return true;
    } // o usuario está habititado-true
}
